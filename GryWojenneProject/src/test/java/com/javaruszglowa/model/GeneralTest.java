...
class GeneralTest {
    ...
    void testPerformManeuvers() {
        General general = new General("Alexander", 100);
        general.recruitSoldier(Soldier.Rank.CORPORAL);
        ...
        assertAll(
            ...
            () -> assertEquals(98, general.getGold(), "Złoto powinno zmniejszyć się o koszt manewrów")
        );
    }
    ...
    void testPerformManeuversInsufficientGold() {
        // Testuje próbę przeprowadzenia manewrów przy braku złota
    ...
    void testAttackWin() {
        ...
        assertAll(
            () -> assertTrue(attacker.getGold() > 200, "Atakujący powinien zyskać złoto po wygranej"),
    ...
    void testAttackLose() {
        ...
        assertAll(
            () -> assertTrue(attacker.getGold() < 200, "Atakujący powinien stracić złoto po przegranej"),
            () -> assertTrue(defender.getGold() > 200, "Obrońca powinien zyskać złoto po wygranej"),
            () -> assertEquals(2, defender.getArmy().get(0).getExperience(), "Żołnierz obrońcy powinien zyskać doświadczenie"),
            () -> assertEquals(0, attacker.getArmy().get(0).getExperience(), "Żołnierz atakującego powinien stracić doświadczenie")
        );
    }
