...
class EmployeeRegistryTest {
    ...
    void testAddNullEmployee() {
        // Trying to add a null employee to the registry
        assertThrows(IllegalArgumentException.class, () -> {
            ArrayList<Employee> nullEmployeeList = new ArrayList<>();
            nullEmployeeList.add(null);  
            registry.addEmployees(nullEmployeeList);
        }, "Employee cannot be null."); 
        
        // Check that the registry still contains the initial number of employees (no null employee was added)
    ...
    void testGetEmployeesSortedByAge() {
        ...
        assertAll("Sprawdzanie sortowania według wieku",
    ...
    void testGetEmployeesSortedByLastName() {
        ...
        assertAll("Sprawdzanie sortowania według nazwiska",
    ...
    void testGetEmployeesSortedByExperience() {
        ...
        // Check that the top 3 employees are correctly sorted by their experience in descending order
        assertAll("Sprawdzanie sortowania według doświadczenia",
            () -> assertEquals(20, sorted.get(0).getExperience()), // The employee with the most experience (20 years)
            () -> assertEquals(10, sorted.get(1).getExperience()), // The employee with 10 years of experience
            () -> assertEquals(8, sorted.get(2).getExperience())   // The employee with 8 years of experience
        );
    }
